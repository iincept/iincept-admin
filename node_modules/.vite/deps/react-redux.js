...
//#endregion
//#region node_modules/react-redux/dist/react-redux.legacy-esm.js
	...
	const wrapWithConnect = (WrappedComponent) => {
		...
		function ConnectFunction(props) {
			...
			const overriddenContextValue = import_react.useMemo(() => {
				...
				return __spreadProps(__spreadValues({}, contextValue), { subscription });
			}, [
				didStoreComeFromProps,
				contextValue,
				subscription
...
`;
			...
			const renderedWrappedComponent = import_react.useMemo(() => {
				return /* @__PURE__ */ import_react.createElement(WrappedComponent, __spreadProps(__spreadValues({}, actualChildProps), { ref: reactReduxForwardedRef }));
			}, [
		...
		if (forwardRef) {
			const forwarded = import_react.forwardRef(function forwardConnectRef(props, ref) {
				return /* @__PURE__ */ import_react.createElement(Connect, __spreadProps(__spreadValues({}, props), { reactReduxForwardedRef: ref }));
			});
